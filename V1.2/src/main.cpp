...
#define DIS_BL_ON  (digitalWrite(DIS_BL, 1))
#define DIS_BL_OFF (digitalWrite(DIS_BL, 0))

#define IR_IN_PWR_ON  (digitalWrite(IR_IN_EN, 1))
...
//U8G2_ST7565_ZOLEN_128X64_F_4W_SW_SPI u8g2(U8G2_R0, DIS_SCK, DIS_SDA, DIS_CS, DIS_DC, DIS_RST);
//U8G2_ST7565_LX12864_F_4W_SW_SPI u8g2(U8G2_R0, DIS_SCK, DIS_SDA, DIS_CS, DIS_DC, DIS_RST);
U8G2_ST7565_ERC12864_ALT_F_4W_SW_SPI u8g2(U8G2_R0, DIS_SCK, DIS_SDA, DIS_CS, DIS_DC, DIS_RST);
...
void printLCD()
{
	...
	if (idleClock > 0)
	{
		...
		u8g2.printf("%02d", cfgSleepSec - idleClock);
	}
	//TEMPERATURE
...
void AcModeSwitch()
{
	...
	case kHitachiAc1Fan:
		...
		break;
		case kHitachiAc1Heat:
		//acMode = kHitachiAc1Auto;	//disable auto mode
...
String GetDeviceInfoString()
{
	...
	String result = "Power round: " + String(upCount);
